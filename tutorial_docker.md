...
Pide al administrador del servidor que añada tu usuario al grupo `docker` del servidor. Consulta también en qué puerto del servidor puedes colocar tu servi
...
~~~
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDUzMjEwODg2XX0=
-->