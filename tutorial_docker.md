...
La opción `-p` permite redirigir el puerto 8080 del anfitrión al 80 del contenedor. Así, accediendo a `localhost:
...
~~~
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MjE3MDQ2MzQsMTgzMTE1NzQ2N119
-->