...
La opción `-p` permite redirigir el puerto 8080 del anfitrión al 80 del contenedor. Así, accediendo a `localhost:8080` desd
...
~~~
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTk0NDI0ODM2LDE4MzExNTc0NjddfQ==
-->