...
En el puerto 80 de `simidat-apps` se ejecuta un servidor web Apache. Si tu servicio incluye una página web 
...
~~~
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMjA4Nzc4OTcsMTgzMTE1NzQ2N119
-->