...
Evaluation metrics are now exported individually, but you can keep using the `mldr_evaluate` function for a full report on the performance of a classifier. A
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzE4MzQyMzQ4XX0=
-->