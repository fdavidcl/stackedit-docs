...
Evaluation metrics are now exported individually, but you can keep using the `mldr_evaluate` function for a full report on the person
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc0Mzk3NDc5N119
-->