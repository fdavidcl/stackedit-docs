...
- My primary objective here was to run Tensorflow on the GPU, but this should be a starting point for running other applications 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAyOTg1NjY1NV19
-->